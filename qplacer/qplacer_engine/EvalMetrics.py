...
class EvalMetrics (object):
    ...
    def __str__(self):
        ...
        if self.frequency_density is not None:
            content += ", Frequency Density %.3E" % (self.frequency_density)
    ...
    def evaluate(self, placedb, ops, var, data_collections=None):
        ...
        with torch.no_grad():
            ...
            if "frequency" in ops:
                self.frequency_density = ops["frequency"](var).data

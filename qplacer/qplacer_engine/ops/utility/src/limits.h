...
#ifndef _QPLACER_UTILITY_LIMITS_H
#define _QPLACER_UTILITY_LIMITS_H
...
struct numeric_limits<char> : public numeric_limits_base<char> {
  ...
  QPLACER_HOST_DEVICE static constexpr type min() noexcept {
    return CHAR_MIN;
  }

  /** The maximum finite value.  */
  QPLACER_HOST_DEVICE static constexpr type max() noexcept {
    return CHAR_MAX;
  }

  /** A finite value x such that there is no other finite value y
   *  where y < x.  */
  QPLACER_HOST_DEVICE static constexpr type lowest() noexcept {
    return CHAR_MIN;
  }

  /** A the machine epsilon.  */
  QPLACER_HOST_DEVICE static constexpr type epsilon() noexcept { return 0; }
};
...
struct numeric_limits<unsigned char>
  ...
  /** The minimum finite value, or for floating types with
    denormalization, the minimum positive normalized value.  */
  QPLACER_HOST_DEVICE static constexpr type min() noexcept { return 0; }
  ...
  /** A finite value x such that there is no other finite value y
   *  where y < x.  */
  QPLACER_HOST_DEVICE static constexpr type lowest() noexcept { return 0; }
...
struct numeric_limits<float> : public numeric_limits_base<float> {
  ...
  /** A the machine epsilon.  */
  QPLACER_HOST_DEVICE static constexpr type epsilon() noexcept {
    return FLT_EPSILON;
  }
};
